        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("form", { onSubmit: onSubmit },
                React.createElement("div", { className: 'form-group' },
                    ...
                    React.createElement("input", { type: "text", className: "form-control", id: "FirstName", value: firstName, onChange: updateFirstName })),
                React.createElement("div", { className: 'form-group' },
                    React.createElement("label", { htmlFor: 'LastName' }, "Last Name:"),
                    React.createElement("input", { type: "text", className: "form-control", id: "LastName", value: lastName, onChange: updateLastName })),
                React.createElement("div", { className: 'form-group' },
                    React.createElement("label", { htmlFor: 'Address' }, "Address:"),
                    React.createElement("input", { type: "text", className: "form-control", id: "Address", value: address, onChange: updateAddress })),
                React.createElement("div", { className: 'form-group' },
                    React.createElement("label", { htmlFor: 'Age' }, "Age:"),
                    React.createElement("input", { type: "text", className: "form-control", id: "Age", value: age, onChange: updateAge })),
                React.createElement("div", { className: 'form-group' },
                    React.createElement("label", { htmlFor: 'Interests' }, "Interests:"),
                    React.createElement("input", { type: "text", className: "form-control", id: "Interests", value: interests, onChange: updateInterests })),
                React.createElement("div", { className: 'form-group' },
                    React.createElement("label", { htmlFor: 'PortraitURL' }, "Portrait URL:"),
                    React.createElement("input", { type: "text", className: "form-control", id: "PortraitURL", value: portraitURL, onChange: updatePortraitURL })),
